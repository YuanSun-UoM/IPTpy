...
# bash /work/n02/n02/yuansun/shell_scripts/archive/IPT-py/ceds.sh
# this script is used to run FCnudged with CEDS anthropogenic emissions for testing IPT-py
# squeue -u yuansun
module load cray-python/3.9.13.1
export CESM_ROOT="/work/n02/n02/yuansun/cesm"
export CESM_INPUT="/work/n02/n02/yuansun/cesm/cesm_inputdata/"
...
export ANT_PERIOD=${STARTYEAR}${STARTMONTH}${STARTDAY}_${ENDYEAR}1216
export EMIS_DATE=20250131
export SOURCE='CEDS'
export VERSION='v2021-04-21'
...
echo "ext_frc_specifier		= 'bc_a4 -> ${CESM_INPUT}atm/cam/chem/emis/emissions_ssp370/emissions-cmip6-ScenarioMIP_IAMC-AIM-ssp370-1-1_bc_a4_aircraft_vertical_mol_175001-210101_0.9x1.25_c20190222.nc',
         'NO2    -> ${CESM_INPUT}atm/cam/chem/emis/emissions_ssp370/emissions-cmip6-ScenarioMIP_IAMC-AIM-ssp370-1-1_NO2_aircraft_vertical_mol_175001-210101_0.9x1.25_c20190222.nc',
         'num_a1 -> ${RENAMED_PATH}${SOURCE}${VERSION}_num_so4_a1_anthro-ene-vertical_${ANT_PERIOD}_0.9x1.25_c${EMIS_DATE}.nc',
         'num_a1 -> ${CESM_INPUT}atm/cam/chem/emis/CMIP6_emissions_1750_2015/emissions-cmip6_num_a1_so4_contvolcano_vertical_850-5000_0.9x1.25_c20170724.nc',
         'num_a2 -> ${CESM_INPUT}atm/cam/chem/emis/CMIP6_emissions_1750_2015/emissions-cmip6_num_a2_so4_contvolcano_vertical_850-5000_0.9x1.25_c20170724.nc',
         'num_a4 -> ${CESM_INPUT}atm/cam/chem/emis/emissions_ssp370/emissions-cmip6-ScenarioMIP_IAMC-AIM-ssp370-1-1_num_bc_a4_aircraft_vertical_mol_175001-210101_0.9x1.25_c20190222.nc',
         'SO2    -> ${CESM_INPUT}atm/cam/chem/emis/emissions_ssp370/emissions-cmip6-ScenarioMIP_IAMC-AIM-ssp370-1-1_SO2_aircraft_vertical_mol_175001-210101_0.9x1.25_c20190222.nc',
         'SO2    -> ${CESM_INPUT}atm/cam/chem/emis/CMIP6_emissions_1750_2015/emissions-cmip6_SO2_contvolcano_vertical_850-5000_0.9x1.25_c20170724.nc',
         'SO2    -> ${CESM_INPUT}atm/cam/chem/stratvolc/VolcanEESMv3.10_piControl_SO2_1850-2014average_ext_1deg_ZeroTrop_c181020.nc',
         'so4_a1 -> ${RENAMED_PATH}${SOURCE}${VERSION}_so4_a1_anthro-ene-vertical_${ANT_PERIOD}_0.9x1.25_c${EMIS_DATE}.nc',
         'so4_a1 -> ${CESM_INPUT}atm/cam/chem/emis/CMIP6_emissions_1750_2015/emissions-cmip6_so4_a1_contvolcano_vertical_850-5000_0.9x1.25_c20170724.nc',
         'so4_a2 -> ${CESM_INPUT}atm/cam/chem/emis/CMIP6_emissions_1750_2015/emissions-cmip6_so4_a2_contvolcano_vertical_850-5000_0.9x1.25_c20170724.nc'" >> user_nl_cam
# horizontal inputs
# CAM63 does not use:
...
echo "srf_emis_specifier		= 'BENZENE -> ${RENAMED_PATH}${SOURCE}${VERSION}_BENZENE_anthro_${ANT_PERIOD}_0.9x1.25_c${EMIS_DATE}.nc',
         ...
         'C2H4 -> ${CESM_INPUT}atm/cam/chem/emis/emissions_ssp370/emissions-cmip6-SSP_C2H4_other_surface_mol_175001-210101_0.9x1.25_c20190222.nc',
         ...
         'C2H6 -> ${CESM_INPUT}atm/cam/chem/emis/emissions_ssp370/emissions-cmip6-SSP_C2H6_other_surface_mol_175001-210101_0.9x1.25_c20190222.nc',
         'C3H6 -> ${RENAMED_PATH}${SOURCE}${VERSION}_C3H6_anthro_${ANT_PERIOD}_0.9x1.25_c${EMIS_DATE}.nc',
         'C3H6 -> ${CESM_INPUT}atm/cam/chem/emis/emissions_ssp370/emissions-cmip6-SSP_C3H6_other_surface_mol_175001-210101_0.9x1.25_c20190222.nc',
         'C3H8 -> ${RENAMED_PATH}${SOURCE}${VERSION}_C3H8_anthro_${ANT_PERIOD}_0.9x1.25_c${EMIS_DATE}.nc',
         'C3H8 -> ${CESM_INPUT}atm/cam/chem/emis/emissions_ssp370/emissions-cmip6-SSP_C3H8_other_surface_mol_175001-210101_0.9x1.25_c20190222.nc',
         ...
         'CO - ${CESM_INPUT}atm/cam/chem/emis/emissions_ssp370/emissions-cmip6-SSP_CO_other_surface_mol_175001-210101_0.9x1.25_c20190222.nc',
         'E90 -> ${CESM_INPUT}atm/cam/chem/emis/CMIP6_emissions_1750_2015/emissions_E90global_surface_1750-2100_0.9x1.25_c20170322.nc',
         ...
         'NH3 -> ${CESM_INPUT}atm/cam/chem/emis/emissions_ssp370/emissions-cmip6-SSP_NH3_other_surface_mol_175001-210101_0.9x1.25_c20190222.nc',
         'NO -> ${RENAMED_PATH}${SOURCE}${VERSION}_NO_anthro_${ANT_PERIOD}_0.9x1.25_c${EMIS_DATE}.nc',
         'NO -> ${CESM_INPUT}atm/cam/chem/emis/emissions_ssp370/emissions-cmip6-SSP_NO_other_surface_mol_175001-210101_0.9x1.25_c20190222.nc',
         ...
         'DMS -> ${CESM_INPUT}atm/cam/chem/emis/emissions_ssp370/emissions-cmip6-ScenarioMIP_IAMC-AIM-ssp370-1-1_DMS_bb_surface_mol_175001-210101_0.9x1.25_c20190222.nc',
