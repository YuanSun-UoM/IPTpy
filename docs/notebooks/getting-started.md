...
IPTpy enables users to generate global anthropogenic emissions from CAMS or CEDS inventories for the FV dycore, covering the most recent historical data. Compared to the original, IPTpy offers greater flexibility by allowing users to generate specific species and specify data on a monthly basis. 
